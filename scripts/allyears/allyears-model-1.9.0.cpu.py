...
#test_path = '/h2o/databackup/test_pdf.csv'
#validate_path = '/h2o/databackup/valid_pdf.csv'
...
if ( trainkey == False  ):
	print("One or more datasets could not be located: please run the following command first:")
